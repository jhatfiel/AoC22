    ...
    inspectAll() {
        while (this.items.length) {
            ...
            if (i !== undefined) {
                ...
                // to keep numbers from getting too large, modulo them by the product of all factors that we are using for divisibility checking (could calculate this based on input but hard coding works)
                i = i % 9699690; // 17 * 3 * 19 * 7 * 2 * 5 * 11 * 13
                //i = i % 96577; // 23 * 19 * 13 * 17
