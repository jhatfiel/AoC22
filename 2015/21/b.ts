...
class Fighter {
    constructor(public name: string, public hp: number, public damage: number, public armor: number) { console.log(`Fighter: ${name} ${hp}hp, ${damage} damage, ${armor} armor`)}
...
p.onClose = () => {
    ...
    let maxCost = 0;
    //attack(weaponArr[0], armorArr[4], ringArr[4], ringArr[5]);
    ...
    // */
    console.log(`Maximum cost losing gear was ${maxCost}`);
